		...
		slimScroll: function (g) {
			...
			this.each(function () {
				...
				if (b.parent().hasClass(a.wrapperClass)) {
					...
					window.addEventListener ? (this.addEventListener("DOMMouseScroll", v, { passive: true }), this.addEventListener("mousewheel", v, { passive: true })) : document.attachEvent("onmousewheel", v)
				}
			});
			return this
		}
